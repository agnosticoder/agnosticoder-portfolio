        ...
        <div className="text-stone-300">
            <div className="mb-16 sm:mb-32 mt-20">
                <h1 className="text-2xl sm:text-3xl font-light text-center mb-16 leading-relaxed sm:leading-loose tracking-wide">
                    Hi 👋🏽, I am <span className="text-yellow-600">Satinder Singh</span>, a self-taught software engineer based in Toronto and I like to build stuff. See my work below.
                </h1>
            </div>
